...
class Course
  def after_add_for_tees(); end

  def after_add_for_tees=(val); end

  def after_add_for_tees?(); end

  def after_remove_for_tees(); end

  def after_remove_for_tees=(val); end

  def after_remove_for_tees?(); end

  def autosave_associated_records_for_tees(*args); end

  def before_add_for_tees(); end

  def before_add_for_tees=(val); end

  def before_add_for_tees?(); end

  def before_remove_for_tees(); end

  def before_remove_for_tees=(val); end

  def before_remove_for_tees?(); end

  def validate_associated_records_for_tees(*args); end
end

class Course::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Course::GeneratedRelationMethods
end

class Course::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Course::GeneratedRelationMethods
end

class Course::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Course::GeneratedRelationMethods
end
...
module Course::GeneratedRelationMethods
end
...
class Course
  def self.after_add_for_tees(); end

  def self.after_add_for_tees=(val); end

  def self.after_add_for_tees?(); end

  def self.after_remove_for_tees(); end

  def self.after_remove_for_tees=(val); end

  def self.after_remove_for_tees?(); end

  def self.before_add_for_tees(); end

  def self.before_add_for_tees=(val); end

  def self.before_add_for_tees?(); end

  def self.before_remove_for_tees(); end

  def self.before_remove_for_tees=(val); end
...
class Hole
  def autosave_associated_records_for_tee(*args); end
end

class Hole::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Hole::GeneratedRelationMethods
end

class Hole::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Hole::GeneratedRelationMethods
end

class Hole::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Hole::GeneratedRelationMethods
end

module Hole::GeneratedAssociationMethods
  def reload_tee(); end
end

module Hole::GeneratedAttributeMethods
  extend ::Mutex_m
end

module Hole::GeneratedRelationMethods
end
...
class JsonSchema::Parser
  ...
  FRIENDLY_TYPES = ::T.let(nil, ::T.untyped)
end
...
class JsonSchema::Validator
  DATE_PATTERN = ::T.let(nil, ::T.untyped)
  DATE_TIME_PATTERN = ::T.let(nil, ::T.untyped)
  DEFAULT_FORMAT_VALIDATORS = ::T.let(nil, ::T.untyped)
  EMAIL_PATTERN = ::T.let(nil, ::T.untyped)
  HOSTNAME_PATTERN = ::T.let(nil, ::T.untyped)
  IPV4_PATTERN = ::T.let(nil, ::T.untyped)
  IPV6_PATTERN = ::T.let(nil, ::T.untyped)
  UUID_PATTERN = ::T.let(nil, ::T.untyped)
end
...
module Polyfill::Module::M70365961068140
end

module Polyfill::Module::M70365961068140
end

module Polyfill::Module::M70365961547920
end

module Polyfill::Module::M70365961547920
end

module Polyfill::Module::M70365966694800
end

module Polyfill::Module::M70365966694800
end

module Polyfill::Module::M70365967139680
end

module Polyfill::Module::M70365967139680
end

module Polyfill::Module::M70365985560660
end

module Polyfill::Module::M70365985560660
end

module Polyfill::Module::M70365985884560
end
...
class Tee
  def after_add_for_holes(); end

  def after_add_for_holes=(val); end

  def after_add_for_holes?(); end

  def after_remove_for_holes(); end

  def after_remove_for_holes=(val); end

  def after_remove_for_holes?(); end

  def autosave_associated_records_for_course(*args); end

  def autosave_associated_records_for_holes(*args); end

  def before_add_for_holes(); end

  def before_add_for_holes=(val); end

  def before_add_for_holes?(); end

  def before_remove_for_holes(); end

  def before_remove_for_holes=(val); end

  def before_remove_for_holes?(); end

  def validate_associated_records_for_holes(*args); end
end

class Tee::ActiveRecord_AssociationRelation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Tee::GeneratedRelationMethods
end

class Tee::ActiveRecord_Associations_CollectionProxy
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Tee::GeneratedRelationMethods
end

class Tee::ActiveRecord_Relation
  include ::ActiveRecord::Delegation::ClassSpecificRelation
  include ::Tee::GeneratedRelationMethods
end

module Tee::GeneratedAssociationMethods
  def hole_ids=(ids); end
...
module Tee::GeneratedRelationMethods
end
...
class Tee
  def self.after_add_for_holes(); end

  def self.after_add_for_holes=(val); end

  def self.after_add_for_holes?(); end

  def self.after_remove_for_holes(); end

  def self.after_remove_for_holes=(val); end

  def self.after_remove_for_holes?(); end

  def self.before_add_for_holes(); end

  def self.before_add_for_holes=(val); end

  def self.before_add_for_holes?(); end

  def self.before_remove_for_holes(); end

  def self.before_remove_for_holes=(val); end
...
class V1::HolesController::HoleParams
  def self.inherited(s); end
end
